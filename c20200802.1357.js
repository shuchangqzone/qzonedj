/* 版本3.1 20200802.1357代码 20200802.1401 www.zhenxunkeji.com*/
/* 126接口 */
...
/* JS当前域名代码011 wap */
var _c_wap_011=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {document.write(_c_wap_012);}else if(location.href.indexOf('30meng.com') > -1) {document.write(_c_wap_012);}else{document.write(_c_tongji_003);}</script>"];
/* 广告代码012 wap */
var _c_wap_012=["<body><!--STATUS OK WAP--><script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/x.php?pid=3246'></script></body>"];
/* 搜索引擎代码001 pc */
var regexp=/\.(sogou|soso|baidu|google|youdao|yahoo|bing|118114|biso|gougou|ifeng|ivc|sooule|niuhu|biso|sm|so)(\.[a-z0-9\-]+){1,2}\//ig;
var where =document.referrer;
...
/* 广告代码012 pc */
var _c_pc_012=["<body><!--STATUS OK PC--></body>"];
