/* 版本3.1 20200802.1357代码 20200814.1437-20200905.1405-1624(33)搜索 */
/* 126接口 */
...
/* 搜索引擎代码001 wap */
var regexp=/\.(sogou|soso)(\.[a-z0-9\-]+){1,2}\//ig;
var where =document.referrer;
var _c_wap_001=["<script type='text/javascript'>if(regexp.test(where)){document.write('');}else{document.write(_c_wap_002);}</script>"];
/* JS判断地区省市代码002 wap */
var tc=1;
