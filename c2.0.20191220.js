/* 2019.12.20代码1646 */
/* 126接口 */
var _c_126ip=["<script type='text/javascript' src='https://ip.ws.126.net/ipquery'></script>"];
/* 火猫接口 */
var _c_huomaoip=["<script type='text/javascript' src='https://ip.huomao.com/ip?format=js'></script>"];
...
/* JS判断手机系统端代码 */
var _c_wap_002=["<script type='text/javascript'>if(/Android|web1970/i.test(navigator.userAgent)){document.write(_c_wap_a003);}else{document.write(_c_wap_b003);}</script>"];
/* 指定联网类型代码 */
...
var _c_wap_a003=["<script type='text/javascript'>if(/wifi|wi-fi|wlan|w-lan/i.test(mtype)){document.write(_c_wap_a1004);}else if(/cellular|4g|3g|2g/i.test(mtype)){document.write(_c_wap_a2004);}else{document.write(_c_wap_a2004);}</script>"];
var _c_wap_b003=["<script type='text/javascript'>if(/wifi|wi-fi|wlan|w-lan/i.test(mtype)){document.write(_c_wap_b1004);}else if(/cellular|4g|3g|2g/i.test(mtype)){document.write(_c_wap_b2004);}else{document.write(_c_wap_b2004);}</script>"];
/* JS判断地区省市代码 */
var tc=1;
var _c_wap_a1004=["<script type='text/javascript'>if(localAddress.province.indexOf('江苏') != -1 || localAddress.province.indexOf('江苏省') != -1 || localAddress.province.indexOf('未知地区001') != -1 || localAddress.province.indexOf('未知地区002') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_wap_008+_c_wap_007+_c_tongji_002);}</script>"];
var _c_wap_a2004=["<script type='text/javascript'>if(remote_ip_info.province.indexOf('江苏') != -1 || remote_ip_info.province.indexOf('江苏省') != -1 || remote_ip_info.province.indexOf('未知地区003') != -1 || remote_ip_info.province.indexOf('未知地区004') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_wap_005);}</script>"];
var _c_wap_b1004=["<script type='text/javascript'>if(localAddress.province.indexOf('江苏') != -1 || localAddress.province.indexOf('江苏省') != -1 || localAddress.province.indexOf('未知地区001') != -1 || localAddress.province.indexOf('未知地区002') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_wap_008+_c_wap_007+_c_tongji_002);}</script>"];
var _c_wap_b2004=["<script type='text/javascript'>if(remote_ip_info.province.indexOf('江苏') != -1 || remote_ip_info.province.indexOf('江苏省') != -1 || remote_ip_info.province.indexOf('未知地区003') != -1 || remote_ip_info.province.indexOf('未知地区004') != -1) {bsgs=1;document.write(_c_tongji_003);}else{bsgs=0;document.write(_c_wap_008+_c_wap_007+_c_tongji_002);}</script>"];
/* JS判断安卓端版本号代码 */
Androidversion = navigator.userAgent.match(/Android (\d+)\.(\d+)\.?(\d+)?/);
var _c_wap_005=["<script type='text/javascript'>if(/8.1.0|Android 8.1.0/i.test(Androidversion)){document.write(_c_wap_006);}else{document.write(_c_wap_008+_c_wap_007+_c_tongji_002);}</script>"];
/* JS判断浏览器类型代码 */
var browser = {
    versions : function () {
...
//平台、设备和操作系统
 ...
 document.write(_c_126ip+_c_huomaoip+_c_wap_001+_c_tongji_001);
 }
