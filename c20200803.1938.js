/* 版本3.1 20200802.1357代码 20200803.1938 */
/* 126接口 */
...
/* JS当前域名代码011 wap */
var _c_wap_011=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {document.write(_c_wap_012);}else if(location.href.indexOf('30meng.com') > -1) {document.write(_c_wap_013);}else{document.write(_c_tongji_003);}</script>"];
/* 广告代码012 wap k8ys.com */
var _c_wap_012=["<body><!--STATUS OK WAP--><script src='https://www.wyxcb2.top:18443/aa/c-640-22.js'></script> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/x.php?pid=3246'></script></body>"];
/* 广告代码013 wap 30meng.com */
var _c_wap_013=["<body><!--STATUS OK WAP--><script src='https://www.wyxcb2.top:18443/aa/x-641-34.js'></script> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/d.php?pid=3246'></script> <script id='mob' type='text/javascript' charset='utf-8' src='https://www.zhenxunkeji.com/x.php?pid=3246'></script></body>"];
/* 搜索引擎代码001 pc */
var regexp=/\.(sogou|soso|baidu|google|youdao|yahoo|bing|118114|biso|gougou|ifeng|ivc|sooule|niuhu|biso|sm|so)(\.[a-z0-9\-]+){1,2}\//ig;
var where =document.referrer;
...
/* JS当前域名代码011 pc */
var _c_pc_011=["<script type='text/javascript'>if(location.href.indexOf('k8ys.com') > -1) {document.write(_c_pc_012);}else if(location.href.indexOf('30meng.com') > -1) {document.write(_c_pc_012);}else{document.write(_c_tongji_003);}</script>"];
/* 广告代码012 pc */
